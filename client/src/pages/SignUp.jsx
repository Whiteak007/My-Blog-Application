...
const SignUp = () => {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen w-full bg-gradient-to-br from-indigo-500 to-purple-600 flex justify-center items-center p-4"
        >
            <motion.div
                        ...
                        <Form {...form}>
                            ...
                            >
                                ...
                                >
                                    <Button 
                                        type="submit" 
                                        className="w-full bg-white text-indigo-600 hover:bg-white/90 h-11 text-sm font-semibold rounded-lg transition-all duration-300 shadow-lg cursor-pointer hover:shadow-xl"
                                    ...
                                    >
                                        ...
                                        <Link 
                                            className='text-white font-semibold hover:underline hover:text-white/90 transition-colors duration-300'
                                            to={RouteSignIn}
                                        >
                                            Sign In
                                        </Link>
